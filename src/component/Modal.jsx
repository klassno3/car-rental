...
const Modal = ({ onClose, children, actionBar }) => {
  ...
  return (
   <div>
      ...
      <div className="fixed z-50 w-[80vw] h-[80vw] md:w-[60vw] md:h-[80vh] top-[50%] -translate-x-1/2 -translate-y-1/2 right-1/2 bottom-1/2 left-1/2 bg-white p-6 lg:p-12 overflow-y-auto">
